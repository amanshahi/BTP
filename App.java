...
public class App implements Runnable {
    ...
    // changed value from 900 to 600 for single hop cases
    boolean isWithinRangeCT(Vehicle car, RSU tower) {
        return distanceCT(car, tower) <= 600;
    }
...
//                    }
                ...
                // System.out.println(s[0] + s[1]);
                // System.out.println(eligibleCars.size());
                Lock lock = car.getLock();
                if (lock.tryLock()) {
                    try {
                        // This part of code requires confirmation.
                        // numberOfCollisions--;
                        // System.out.println(s[0] + s[1] + " Entered\n");
...
//                                System.out.println(deliPackets);
                    ...
                    // System.out.println(s[0] + s[1] + " Didn't get");
                    try {
                        // Add exponentiation backoff here .. 
                        // numberOfCollisions++;
                        // int inpow = (int)(Math.pow(2,numberOfCollisions)) - 1;
                        // int waitTime = rand.nextInt(inpow) + 1;
